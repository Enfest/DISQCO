model_config = {
    ...
    "clip_ratio": 0.3,       # PPO Clip
    "ent_coef": 0.5,        # Entropy Coefficient (Exploration) 
    "num_qubits": 6,        # Circuit Size
    "num_qpus": 2,           # Env Topology
    "hex_dist": 3,           # Env Size
    "hidden_dim": 8,        # GNN Size
    ...
    "window_depth": 6,      # Execution Window Depth
    "switch_frequency": 4      # Frequency of switching circuit
}